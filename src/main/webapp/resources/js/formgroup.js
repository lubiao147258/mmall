$(document).ready(function() {
    (function () {
        var hintText = {
            ...
            user_name: {hint: "⚠️请输入6-20个字符的用户名（包括字母/数字/下划线）", right: "√用户名格式正确", wrong: "×用户名格式有误，请重新输入"},
            name: {hint: "⚠️请输入4-20姓名", right: "√姓名输入正确", wrong: "×姓名输入有误，请重新输入"},
        ...
        function regValue(id, i) {
            ...
            switch (id) {
                ...
                case "info_user_name":
                    flag = /^[a-zA-Z0-9_]{6,20}$/.test(value.replace(/[\u0391-\uFFE5]/g, "nn"));
                    id = "user_name";
                    break;
                case "name":
                case "send_to_name":
                case "send_from_name":
                    flag = /^[a-zA-Z ]{4,20}$/.test(value.replace(/[\u0391-\uFFE5]/g, "nn"));
                    id = "name";
                    break;
