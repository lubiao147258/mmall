...
var QuestionJosn = [{
    "questionId": "1",
    "questionTitle": " JAVA所定义的版本中不包括： ",
    "questionItems": " JAVA2 EE ;JAVA2 Card;JAVA2 ME;JAVA2 HE; JAVA2 SE",
    "questionAnswer": "d"
}, {
    "questionId": "2",
    "questionTitle": "下列说法正确的是？ ",
    "questionItems": "JAVA程序的main方法必须写在类里面;JAVA程序中可以有多个main方法;JAVA程序中类名必须与文件名一样;JAVA程序的main方法中如果只有一条语句，可以不用{}(大括号)括起来;",
    "questionAnswer": "a"
}, {
    "questionId": "3",
    "questionTitle": "若某线性表中最常用的操作是取第I个元素和找第I个元素的前趋元素，则采用____存储方式最节省时间。 ",
    "questionItems": "顺序表;单链表;双链表;单循环链表",
    "questionAnswer": "a"
}, {
    "questionId": "4",
    ...
    "questionId": "5",
    "questionTitle": "Swing与aWT的区别不包括 ",
    "questionItems": "Swing是由纯Java实现的轻量级构件;Swing没有本地代码;Swing不依赖操作系统的支持;Swing支持图形用户界面",
    "questionAnswer": "d"
}, {
    "questionId": "6",
